...
const EditUserModal = ({ handleclose, usertoedit, fetchUsers }) => {
  ...
  const handleUseredit = async (e) => {
    ...
    if (
      fullname === usertoedit.fname &&
      contact === usertoedit.mobile_no &&
      useremail === usertoedit.email &&
      selectedAgency === usertoedit.agency?._id &&
      selectedGEI === usertoedit.gie?._id
    ) {
